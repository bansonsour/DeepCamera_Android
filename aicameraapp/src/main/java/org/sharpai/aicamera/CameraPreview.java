...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private class PreviewCallback implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            Bitmap bmp = mDetection.yuv2Bitmap(data,PREVIEW_WIDTH,PREVIEW_HEIGHT);

            //Bitmap rotatedBmp = Bitmap.createBitmap(PREVIEW_HEIGHT, PREVIEW_WIDTH, Bitmap.Config.ARGB_8888);

            //Canvas canvas = new Canvas(rotatedBmp);
            //canvas.drawBitmap(bmp, frameRotateTransform, null);

            mDetection.processBitmap(bmp);
